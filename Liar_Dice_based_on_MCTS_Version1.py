# -*- coding: utf-8 -*-
"""
Created on Fri May 14 16:48:41 2021
...
class MCTS(object):
    ...
    def run_simulation(self, record, play_turn):
        ...
        for i in range(1, self.max_actions + 1):
            ...
            if next_policy in [0,1,7,13,19,25,31,37,43]:
    ...
    def decide_the_winner(self, record):
        ...
        if self.if_one_is_applied == False:
            if total_dices.count(1) + total_dices.count(key_num) >= curr_decision[0]:
...
class Human_player(object):
    ...
    def get_action(self, current_state):
        try:
            print("Your dices are:", self.dices)
...
class Game(object):
    ...
    def start_game(self):
        ...
        while(1):
            ...
            if order in [1,7,13,19,25,31,37,43]:
                self.if_one_is_applied = True
            ...
            if order == 49:
                ...
                print("Ai's Dices are:", self.ai_dices)
                print("Human's Dices are:", self.human_dices)
                break
